...
suggestion, feel free to open an issue or pull request. (Last updated: 2026-06-21)
...
- [CrewAI](https://github.com/joaomdmoura/crewAI) - Framework for orchestrating
  ...
  54,049 stars · 7,566 forks · 297 contributors · 514 issues · Python · MIT
...
- [Langchain](https://github.com/hwchase17/langchain) - Building applications with LLMs
  ...
  139,780 stars · 23,183 forks · 469 contributors · 415 issues · Python · MIT
...
- [Microsoft AutoGen](https://github.com/microsoft/autogen) - Framework for building
  ...
  59,098 stars · 8,918 forks · 445 contributors · 910 issues · Python · CC-BY-4.0
...
- [OpenManus](https://github.com/FoundationAgents/OpenManus) - Open-source AI agent
  ...
  56,609 stars · 9,848 forks · 53 contributors · 522 issues · Python · MIT
...
- [Llama Index](https://github.com/run-llama/llama_index) - Data framework for LLM
  ...
  50,245 stars · 7,597 forks · 474 contributors · 490 issues · Python · MIT
...
- [Microsoft Semantic Kernel](https://github.com/microsoft/semantic-kernel) -
  ...
  28,168 stars · 4,657 forks · 397 contributors · 264 issues · C# · MIT
...
- [Dify](https://github.com/langgenius/dify) - Open-source framework for LLM
  ...
  145,986 stars · 22,958 forks · 460 contributors · 783 issues · TypeScript · NOASSERTION
...
- [Haystack](https://github.com/deepset-ai/haystack) - End-to-end NLP framework
  ...
  25,617 stars · 2,869 forks · 368 contributors · 108 issues · MDX · Apache-2.0
...
- [Embedchain](https://github.com/embedchain/embedchain) - Framework for ChatGPT-like
  ...
  59,003 stars · 6,808 forks · 343 contributors · 381 issues · Python · Apache-2.0
...
- [Google ADK](https://github.com/google/adk-python) - Agent Development Kit for
  ...
  20,202 stars · 3,602 forks · 328 contributors · 710 issues · Python · Apache-2.0
...
- [SuperAGI](https://github.com/TransformerOptimus/SuperAGI) - Open-source autonomous AI
  ...
  17,577 stars · 2,215 forks · 62 contributors · 267 issues · Python · MIT
...
- [Kiln AI](https://github.com/Kiln-AI/Kiln) - Tools for building AI products including
  ...
  4,919 stars · 370 forks · 13 contributors · 74 issues · Python · NOASSERTION
...
- [AGiXT](https://github.com/Josh-XT/AGiXT) - Scalable framework for AI agents
  ...
  3,198 stars · 447 forks · 41 contributors · 2 issues · Python · MIT
...
- [XAgent](https://github.com/OpenBMB/XAgent) - Autonomous LLM-based agent framework
  ...
  8,528 stars · 905 forks · 33 contributors · 62 issues · Python · Apache-2.0
...
- [Neurolink](https://github.com/juspay/neurolink) - Multi-provider AI agent framework
  ...
  103 stars · 110 forks · 60 contributors · 290 issues · TypeScript · MIT
...
- [OpenAgents](https://github.com/xlang-ai/OpenAgents) - Open platform for language
  ...
  4,843 stars · 531 forks · 16 contributors · 14 issues · Python · Apache-2.0
...
- [AI Legion](https://github.com/eumemic/ai-legion) - Swarm framework for autonomous
  ...
  1,430 stars · 171 forks · 6 contributors · 9 issues · TypeScript · MIT
...
- [Agent Protocol](https://github.com/e2b-dev/agent-protocol) - Unified interface for AI
  ...
  1,462 stars · 184 forks · 14 contributors · 47 issues · Python · MIT
...
- [Agents.js](https://github.com/Webgburnet/Agents.js) - JavaScript framework for
  ...
  - Easy integration with OpenAI, Anthropic, Gemini, and other models- [PraisonAI](https://github.com/MervinPraison/PraisonAI) - Production-ready Multi-AI
  Agents framework with self-reflection

  8,088 stars · 1,236 forks · 43 contributors · 128 issues · Python · MIT
...
- [Tambo](https://github.com/tambo-ai/tambo) - React framework for building AI-powered
  ...
  11,151 stars · 570 forks · 60 contributors · 30 issues · TypeScript · MIT
...
- [OpenAgents](https://github.com/openagents-org/openagents) - Open-source platform for
  ...
  3,785 stars · 379 forks · 25 contributors · 81 issues · Python · Apache-2.0
...
- [Cordum](https://github.com/cordum-io/cordum) - Safety-first agent orchestration
  ...
  484 stars · 30 forks · 6 contributors · 17 issues · Go · NOASSERTION
...
- [AgentField](https://github.com/Agent-Field/agentfield) - Open-source infrastructure
  ...
  2,201 stars · 357 forks · 39 contributors · 91 issues · Go · Apache-2.0
...
- [DeepAnalyze](https://github.com/ruc-datalab/DeepAnalyze) - Agentic LLM for autonomous
  ...
  4,270 stars · 686 forks · 12 contributors · 22 issues · Python · MIT
...
- [agent-opt](https://github.com/future-agi/agent-opt) - Open-source optimization engine
  ...
  69 stars · 7 forks · 5 contributors · 0 issues · Python · Apache-2.0
...
- [Quorum](https://github.com/Detrol/quorum-cli) - Multi-agent AI discussion system for
  ...
  106 stars · 9 forks · 1 contributors · 1 issues · Python · NOASSERTION
...
- [Loopy](https://github.com/arjunkshah/loopy) - Free, local-first agent operating system
  that ships work from a board with a fleet of coding agents

  27 stars · 6 forks · 2 contributors · 2 issues · Python · MIT

  - Orchestrates 43 coding-agent CLIs: Codex, Claude Code, Cursor, Gemini, and more
  - Complexity-aware routing: big tasks spawn dedicated agents, small tasks append to an existing loop
  - Named subagents (Ada, Turing, Hopper…) that spawn helpers, with live status in the dashboard
  - Honest ship receipts: real integration status, evidence packs, and token-preservation metrics
  - Human-in-the-loop steering by email or Linear; runs on your machine and your keys
